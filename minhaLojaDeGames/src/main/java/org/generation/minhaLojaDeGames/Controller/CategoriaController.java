...
public class CategoriaController {
	...
	public ResponseEntity<List<Categoria>> getByName (@PathVariable String nomeConsole){
		return ResponseEntity.ok(repository.findAllByNomeConsoleContainingIgnoreCase(nomeConsole));
	}
